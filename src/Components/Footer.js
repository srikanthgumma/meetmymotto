...
const Footer = ({ nav }) => {
  return (
    <section className=' text-white m-0 w-full max-w-full bg-gray-900'>
      {nav ? <a href="#home"><div className='hover:bg-[#ff44ef] w-14 h-14 fixed right-10 bottom-10 text-2xl flex justify-center items-center rounded-full cursor-pointer bg-blue-900 '><TbArrowBigUpFilled /></div></a> : "none"}
      <footer>
        <div className=" py-4 text-gray-400">
          <div className="container px-4 mx-auto">
            <div className="-mx-4 flex flex-wrap justify-between">
              <div className="px-4 my-4 w-full ">
                <a href="/" className="block w-full mb-5 text-white text-3xl sm:text-5xl font-sans font-bold" >
                  Meetmymotto
                </a>
              ...
              <div className="px-4 my-4 w-full sm:w-auto ">
                <div>
                  <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-900 font-sans font-bold hover:text-white">Connect With Us</h2>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="-mx-4 flex flex-wrap justify-between">
              <div className="px-4 w-full text-center sm:w-auto sm:text-left font-sans">
                Copyright © 2024- 2025     Vriddhi Media. All Rights Reserved.
              </div>
              <div className="px-4 w-full text-center sm:w-auto sm:text-left font-sans">
                Made with ❤️ by Srikanth Gummadi.
              </div>
            </div>
          </div>
        </div>
