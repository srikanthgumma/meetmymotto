    ...
    <section id="insights" className=" bg-transparent">
      ...
      <marquee>
        <div className='flex gap-4'>
          {/* <img src={require('../assets/testimonals/1.jpg')} width='250' height='100' />
          <img src={require('../assets/testimonals/2.jpg')} width='250' height='100' />
          <img src={require('../assets/testimonals/3.jpg')} width='250' height='100' />
          <img src={require('../assets/testimonals/4.jpg')} width='250' height='100' /> */}
